-- Corrected seed file using only existing columns
-- Based on the error, we'll use only basic columns that exist
...
-- Sefalana (Supermarket) - Using only basic columns
...
('Moet & Chandon', 'moet-chandon', 850.00, 1),
